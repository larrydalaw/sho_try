angular.module('myApp').controller('ListNewwController', 
  ['$http', '$scope', '$location', '$q', '$timeout', '$modal', 'SecurityService', 'NavigationService', 'EntityUtilService', 'NewwService', 
  function($http, $scope, $location, $q, $timeout, $modal, SecurityService, NavigationService, EntityUtilService, NewwService) {
	...
	$scope.add = function () {
		$location.path('/neww/add');
	};

	$scope.edit = function (obj) {
		$location.path('/neww/edit/' + obj._id);
	};
	$scope.view = function (obj) {
		$location.path('/neww/view/' + obj._id);
	};
	$scope.delete = function (obj) {
		$location.path('/neww/delete/' + obj._id);
	};
	...
	function doDeleteByQuery() {
		...
		return EntityUtilService.deleteByQuery(NewwService, searchCriteria, $scope.refresh);  		
	}
	...
	function doDeleteSelected() {
		EntityUtilService.deleteSelected(NewwService, $scope.dataList, $scope.refresh);  
	}
	...
	function init() {
		SecurityService.getPermisionsFoResource('neww').then(function(httpData) {
