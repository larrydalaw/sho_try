...
angular.module('myApp', ['ngRoute', 'ngCookies', 'ui.bootstrap', 'ui.bootstrap.datetimepicker',
	...
	.config(['$routeProvider', function ($routeProvider) {
		$routeProvider
			...
			.when('/neww/',			 { templateUrl: 'views/neww/list.html',   controller: 'ListNewwController' })
			.when('/neww/select',	 { templateUrl: 'views/neww/select.html', controller: 'SelectNewwController' })
			.when('/neww/add',        { templateUrl: 'views/neww/edit.html',   controller: 'EditNewwController' })
			.when('/neww/edit/:id', 	 { templateUrl: 'views/neww/edit.html',   controller: 'EditNewwController' })
			.when('/neww/delete/:id', { templateUrl: 'views/neww/edit.html', 	 controller: 'EditNewwController' })
			.when('/neww/view/:id', 	 { templateUrl: 'views/neww/edit.html', 	 controller: 'EditNewwController' })
